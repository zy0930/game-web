        ...
        <div className="mx-4 mb-4 bg-primary rounded-xl p-4">
          <div className="flex">
            <div className="flex-1 text-center">
              ...
              <p className="text-white font-bold">MYR {mockSummary.totalTurnover.toFixed(2)}</p>
            </div>
            <div className="flex-1 text-center">
              <p className="text-white/80 text-xs mb-1">Total Profit</p>
              <p className="text-white font-bold">MYR {mockSummary.totalProfit.toFixed(2)}</p>
            </div>
          </div>
        </div>

        {/* Table Header */}
        <div className="grid grid-cols-5 gap-2 px-4 py-3 bg-dark text-white text-xs font-medium">
          <div>Date</div>
          <div>Game</div>
